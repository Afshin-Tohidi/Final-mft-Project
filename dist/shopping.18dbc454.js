...
console.log(card);
let basket = {};
for (let i of minus)i.addEventListener("click", (e)=>{
...
for (let i of plus)i.addEventListener("click", (e)=>{
    let node = i.parentNode.getElementsByTagName("span")[0];
    let count = node.innerText;
    let productName = i.parentNode.parentNode.parentNode.id;
    count++;
...
},{}]},["j2YDk","1SICI"], "1SICI", "parcelRequire2e9c")

//# sourceMappingURL=shopping.18dbc454.js.map
